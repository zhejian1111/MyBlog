...
var CodeComponent = function CodeComponent(_ref) {
  ...
  if (!block) return /*#__PURE__*/React__default["default"].createElement("code", otherProps, children);
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("pre", _extends({}, otherProps, {
    className: styledJsx_cjs.style.dynamic([["1286851807", [SCALES.font(0.875), SCALES.width(1, 'initial'), SCALES.height(1, 'auto'), SCALES.pt(1), SCALES.pr(1.3), SCALES.pb(1), SCALES.pl(1.3), SCALES.mt(1.3), SCALES.mr(0), SCALES.mb(1.3), SCALES.ml(0)]]]) + " " + (otherProps && otherProps.className != null && otherProps.className || className || "")
  }), /*#__PURE__*/React__default["default"].createElement("code", {
    className: styledJsx_cjs.style.dynamic([["1286851807", [SCALES.font(0.875), SCALES.width(1, 'initial'), SCALES.height(1, 'auto'), SCALES.pt(1), SCALES.pr(1.3), SCALES.pb(1), SCALES.pl(1.3), SCALES.mt(1.3), SCALES.mr(0), SCALES.mb(1.3), SCALES.ml(0)]]])
  ...
  }, "pre.__jsx-style-dynamic-selector{max-width:100%;font-size:".concat(SCALES.font(0.875), ";width:").concat(SCALES.width(1, 'initial'), ";height:").concat(SCALES.height(1, 'auto'), ";padding:").concat(SCALES.pt(1), " ").concat(SCALES.pr(1.3), " ").concat(SCALES.pb(1), " ").concat(SCALES.pl(1.3), ";margin:").concat(SCALES.mt(1.3), " ").concat(SCALES.mr(0), " ").concat(SCALES.mb(1.3), " ").concat(SCALES.ml(0), ";}.dark.__jsx-style-dynamic-selector{color:white;background:black;}.dark.__jsx-style-dynamic-selector code.__jsx-style-dynamic-selector{color:white;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=code.tsx */")));
};
